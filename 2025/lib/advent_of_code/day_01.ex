defmodule AdventOfCode.Day01 do
  ...
  defp turn(:left, dial, steps), do: ((dial - steps - @min_value) |> Integer.mod(@range_size)) + @min_value
  defp turn(:right, dial, steps), do: ((dial + steps - @min_value) |> Integer.mod(@range_size)) + @min_value
